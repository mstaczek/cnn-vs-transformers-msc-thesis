imagenette2_id_to_class_mapping = {int(k):v[0] for k, v in 
                       {"0":   ["n01440764", "tench"],
                        # the following 9 class names are changed from Imagenet and match imagenette2 class names (they are repeated in this list)
                        # this trick makes predictions of models trained both on imagenet and imagenette2 save the same class names for correct predictions
                        # The only caveat is when a model trained on imagenet will predict classes (1-9) which is a mistake on imagenette2 dataset
                        # it will still be saved as if the model predicted imagenette2 class despite not pointing to the correct imagenet class id 
                        "1": ["n02102040", "English_springer"],
                        "2": ["n02979186", "cassette_player"],
                        ...
                        "1001":   ["n01443537", "goldfish"],
                        "1002":   ["n01484850", "great_white_shark"],
                        "1003":   ["n01491361", "tiger_shark"],
                        "1004":   ["n01494475", "hammerhead"],
                        "1005":   ["n01496331", "electric_ray"],
                        "1006":   ["n01498041", "stingray"],
                        "1007":   ["n01514668", "cock"],
                        "1008":   ["n01514859", "hen"],
                        "1009":   ["n01518878", "ostrich"],
                        ...
                        "998": ["n13133613", "ear"],
                        "999": ["n15075141", "toilet_tissue"]}.items()
                       }

imagenette2_class_to_id_mapping = {v: k for k, v in imagenette2_id_to_class_mapping.items()}

imagenette2_classes_dict = {
                        "0":   ["n01440764", "tench"],
...
imagenette2_id_to_name_mapping = {int(k):v[1] for k, v in imagenette2_classes_dict.items()}
imagenette2_class_to_name_mapping = {v[0]:v[1] for k, v in imagenette2_classes_dict.items()}
